                ...
                @foreach ($topNavItems as $nav)
                                ...
                                @foreach ($nav->children[0] as $child)
                                    <li>
                                        @if ($child->type == 'category')
                                            <a class="dropdown-item" href="{{ route('category', $child->slug) }}">
                                                @if ($child->name == null)
                                                    {{ $child->title }}
                                                @else
                                                    {{ $child->name }}
                                        ...
                                        @elseif ($child->type == 'post')
                                            <a class="dropdown-item" href="{{ route('posts', $child->slug) }}"
                                                target="{{ $child->target }}">
                                                @if ($child->name == null)
                                                    {{ $child->title }}
                                                @else
                    ...
                    @else
                        @if ($nav->type == 'category')
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('category', $nav->slug) }}"
                                    target="{{ $nav->target }}">
                                    @if ($nav->name == null)
                                        {{ $nav->title }}
                                    @else
                        ...
                        @elseif ($nav->type == 'post')
                            <li class="nav-item"><a class="nav-link"
                                    href="{{ route('posts', $nav->slug) }}" target="{{ $nav->target }}">
                                    @if ($nav->name == null)
                                        {{ $nav->title }}
                                    @else
                                        {{ $nav->name }}
