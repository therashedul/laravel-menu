                        ...
                        <div class="x_content">
                            @foreach ($categories as $category)
                                ...
                                <div class="form-check">
                                    ...
                                    <input class="form-check-input parent" style="position: absolute;
                                                                                                    left: 67px;
                                                                                                    display: none;"
                                        name="uncat_id[]" type="checkbox" value="{{ $category->id }}"
                                        {{ $checked }}>
                                    <p>{{ $category->name }}</p>
                                </div>
                                    ...
                                    @foreach ($category->subcategory as $sub)
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input child" style="margin-left: 7px;"
                                                ...
                                                {{ $checked }}>
                                            <input class="form-check-input child" style="position: absolute;
                                                                                                    left: 76px;
                                                                                                    display: none;"
